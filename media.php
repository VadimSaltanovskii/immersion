                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <?php if ($current_user["avatar"]) : ?>
                                        <img src="img/demo/avatars/<?php echo $current_user["avatar"] ?>" alt="" class="img-responsive" width="200">
                                    <?php else : ?>
                                        <img src="img/demo/avatars/<?php echo "default.jpeg" ?>" alt="" class="img-responsive" width="200">
                                    <?php endif; ?>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="example-fileinput">Выберите аватар</label>
                                    <input type="file" id="example-fileinput" name="upd_avatar" class="form-control-file">
                                </div>
